...
```groovy
implementation 'com.github.stefan-niedermann:android-commons:0.2.8'
```
...
```groovy
implementation 'com.github.stefan-niedermann.android-commons:shared-preferences:0.2.8'
```
...
```groovy
implementation 'com.github.stefan-niedermann.android-commons:util:0.2.8'
```
