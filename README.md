...
```groovy
implementation 'com.github.stefan-niedermann:android-commons:1.0.3'
```
...
```groovy
implementation 'com.github.stefan-niedermann.android-commons:shared-preferences:1.0.3'
```
...
```groovy
implementation 'com.github.stefan-niedermann.android-commons:reactive-livedata:1.0.3'
```
...
```groovy
implementation 'com.github.stefan-niedermann.android-commons:util:1.0.3'
```
