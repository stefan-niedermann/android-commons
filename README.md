...
```groovy
implementation 'com.github.stefan-niedermann.android-commons:shared-preferences:0.1.1'
```
...
```groovy
implementation 'com.github.stefan-niedermann.android-commons:util:0.1.1'
```
